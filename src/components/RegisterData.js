      ...
      <div className="sub-main">
        <div className="sub-main-content">
          <div style={{ padding: "10px" }}>
            ...
            <div className="login-label-1">Nombre Completo:</div>

            <div className="second-input">
              <input
                type="text"
                placeholder="Roberto Becerril Loya"
                className="name"
                value={name}
                onChange={changeName}
              />
            ...
            <div className="button-group-end">
              <button className="login-button" onClick={crearDoctor1}>
                Guardar Datos
              </button>
            </div>

            <div className="link" style={{ paddingTop: "20px" }}></div>
          </div>
        </div>
      </div>
    </div>
